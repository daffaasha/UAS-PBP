    ...
    <form action="ubahProfile.php" method="POST">
        ...
        <div class="profile-form">
          <div class="form-flex">
            ...
            <div class="input-form-container">
              <input type="text" name = "username" class="input-form" value = "<?php echo $user['USERNAME']?>">
          ...
          <div class="name form-flex">
            ...
            <div class="input-form-container">
              <input type="text" name = "nama" class="input-form" value = "<?php echo $user['NAMA']?>">
              <img src="img/pen.svg" alt="edit" class="edit-icon">
            </div>
          </div>
          <div class="email form-flex">
            ...
            <div class="input-form-container">
              <input type="text" name = "email" class="input-form" value = "<?php echo $user['EMAIL']?>">
              <img src="img/pen.svg" alt="edit" class="edit-icon">
            </div>
          </div>
          <div class="number form-flex">
            ...
            <div class="input-form-container">
              <input type="text" name = "number" class="input-form" value = "<?php echo $user['NUMBER']?>">
              <img src="img/pen.svg" alt="edit" class="edit-icon">
            </div>
          </div>
        </div> 
      ...
      <div class="account-data">
        <div class="form-flex">
          ...
          <div class="input-form-container">
            <input type="text" name = "password" class="input-form" value = "<?php echo $user['PASSWORD']?>">
            <img src="img/pen.svg" alt="edit" class="edit-icon">
          </div>
        </div>
      </div>
      <button type ="submit" class="save-data">SIMPAN</button>
      ...
      <div class="poppup" id="poppup-confirm">
        ...
        <div class="buttons">
          ...
          <button type ="submit" class = "logout-btn">Ubah</button>
